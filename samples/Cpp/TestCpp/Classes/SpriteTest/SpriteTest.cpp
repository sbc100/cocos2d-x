...
TESTLAYER_CREATE_FUNC(Sprite1)
TESTLAYER_CREATE_FUNC(SpriteBatchNode1)
TESTLAYER_CREATE_FUNC(SpriteFrameTest)
TESTLAYER_CREATE_FUNC(SpriteFrameAliasNameTest)
TESTLAYER_CREATE_FUNC(SpriteAnchorPoint)
TESTLAYER_CREATE_FUNC(SpriteBatchNodeAnchorPoint)
TESTLAYER_CREATE_FUNC(SpriteOffsetAnchorRotation)
TESTLAYER_CREATE_FUNC(SpriteBatchNodeOffsetAnchorRotation)
TESTLAYER_CREATE_FUNC(SpriteOffsetAnchorScale)
TESTLAYER_CREATE_FUNC(SpriteBatchNodeOffsetAnchorScale)
TESTLAYER_CREATE_FUNC(SpriteOffsetAnchorSkew)
TESTLAYER_CREATE_FUNC(SpriteOffsetAnchorRotationalSkew)
TESTLAYER_CREATE_FUNC(SpriteBatchNodeOffsetAnchorSkew)
TESTLAYER_CREATE_FUNC(SpriteBatchNodeOffsetAnchorRotationalSkew)
TESTLAYER_CREATE_FUNC(SpriteOffsetAnchorSkewScale)
TESTLAYER_CREATE_FUNC(SpriteOffsetAnchorRotationalSkewScale)
TESTLAYER_CREATE_FUNC(SpriteBatchNodeOffsetAnchorSkewScale)
TESTLAYER_CREATE_FUNC(SpriteBatchNodeOffsetAnchorRotationalSkewScale)
TESTLAYER_CREATE_FUNC(SpriteOffsetAnchorFlip)
TESTLAYER_CREATE_FUNC(SpriteBatchNodeOffsetAnchorFlip)
TESTLAYER_CREATE_FUNC(SpriteAnimationSplit)
TESTLAYER_CREATE_FUNC(SpriteColorOpacity)
TESTLAYER_CREATE_FUNC(SpriteBatchNodeColorOpacity)
TESTLAYER_CREATE_FUNC(SpriteZOrder)
TESTLAYER_CREATE_FUNC(SpriteBatchNodeZOrder)
TESTLAYER_CREATE_FUNC(SpriteBatchNodeReorder)
TESTLAYER_CREATE_FUNC(SpriteBatchNodeReorderIssue744)
TESTLAYER_CREATE_FUNC(SpriteBatchNodeReorderIssue766)
TESTLAYER_CREATE_FUNC(SpriteBatchNodeReorderIssue767)
TESTLAYER_CREATE_FUNC(SpriteBatchNodeReorderSameIndex)
TESTLAYER_CREATE_FUNC(SpriteBatchNodeReorderOneChild)
TESTLAYER_CREATE_FUNC(NodeSort)
TESTLAYER_CREATE_FUNC(SpriteZVertex)
TESTLAYER_CREATE_FUNC(SpriteBatchNodeZVertex)
TESTLAYER_CREATE_FUNC(Sprite6)
TESTLAYER_CREATE_FUNC(SpriteFlip)
TESTLAYER_CREATE_FUNC(SpriteBatchNodeFlip)
TESTLAYER_CREATE_FUNC(SpriteAliased)
TESTLAYER_CREATE_FUNC(SpriteBatchNodeAliased)
TESTLAYER_CREATE_FUNC(SpriteNewTexture)
TESTLAYER_CREATE_FUNC(SpriteBatchNodeNewTexture)
TESTLAYER_CREATE_FUNC(SpriteHybrid)
TESTLAYER_CREATE_FUNC(SpriteBatchNodeChildren)
TESTLAYER_CREATE_FUNC(SpriteBatchNodeChildrenZ)
TESTLAYER_CREATE_FUNC(SpriteChildrenVisibility)
TESTLAYER_CREATE_FUNC(SpriteChildrenVisibilityIssue665)
TESTLAYER_CREATE_FUNC(SpriteChildrenAnchorPoint)
TESTLAYER_CREATE_FUNC(SpriteBatchNodeChildrenAnchorPoint)
TESTLAYER_CREATE_FUNC(SpriteBatchNodeChildrenScale)
TESTLAYER_CREATE_FUNC(SpriteChildrenChildren)
TESTLAYER_CREATE_FUNC(SpriteBatchNodeChildrenChildren)
TESTLAYER_CREATE_FUNC(SpriteSkewNegativeScaleChildren)
TESTLAYER_CREATE_FUNC(SpriteRotationalSkewNegativeScaleChildren)
TESTLAYER_CREATE_FUNC(SpriteBatchNodeSkewNegativeScaleChildren)
TESTLAYER_CREATE_FUNC(SpriteBatchNodeRotationalSkewNegativeScaleChildren)
TESTLAYER_CREATE_FUNC(SpriteNilTexture)
TESTLAYER_CREATE_FUNC(SpriteSubclass)
TESTLAYER_CREATE_FUNC(SpriteDoubleResolution)
TESTLAYER_CREATE_FUNC(SpriteBatchBug1217)
TESTLAYER_CREATE_FUNC(AnimationCacheTest)
TESTLAYER_CREATE_FUNC(AnimationCacheFile)
#endif
