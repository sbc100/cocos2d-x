...
TESTLAYER_CREATE_FUNC(TextureMemoryAlloc)
TESTLAYER_CREATE_FUNC(TextureAlias)
TESTLAYER_CREATE_FUNC(TexturePVRMipMap)
TESTLAYER_CREATE_FUNC(TexturePVRMipMap2)
TESTLAYER_CREATE_FUNC(TexturePVRNonSquare)
TESTLAYER_CREATE_FUNC(TexturePVRNPOT4444)
TESTLAYER_CREATE_FUNC(TexturePVRNPOT8888)
TESTLAYER_CREATE_FUNC(TexturePVRTest)
TESTLAYER_CREATE_FUNC(TexturePVR2BPP)
TESTLAYER_CREATE_FUNC(TexturePVR2BPPv3)
TESTLAYER_CREATE_FUNC(TexturePVR4BPP)
TESTLAYER_CREATE_FUNC(TexturePVR4BPPv3)
TESTLAYER_CREATE_FUNC(TexturePVRII4BPPv3)
TESTLAYER_CREATE_FUNC(TexturePVRRGBA8888)
TESTLAYER_CREATE_FUNC(TexturePVRRGBA8888v3)
TESTLAYER_CREATE_FUNC(TexturePVRBGRA8888)
TESTLAYER_CREATE_FUNC(TexturePVRBGRA8888v3)
TESTLAYER_CREATE_FUNC(TexturePVRRGBA4444)
TESTLAYER_CREATE_FUNC(TexturePVRRGBA4444v3)
TESTLAYER_CREATE_FUNC(TexturePVRRGBA4444GZ)
TESTLAYER_CREATE_FUNC(TexturePVRRGBA4444CCZ)
TESTLAYER_CREATE_FUNC(TexturePVRRGBA5551)
TESTLAYER_CREATE_FUNC(TexturePVRRGBA5551v3)
TESTLAYER_CREATE_FUNC(TexturePVRRGB565)
TESTLAYER_CREATE_FUNC(TexturePVRRGB565v3)
TESTLAYER_CREATE_FUNC(TexturePVRRGB888)
TESTLAYER_CREATE_FUNC(TexturePVRRGB888v3)
TESTLAYER_CREATE_FUNC(TexturePVRA8)
TESTLAYER_CREATE_FUNC(TexturePVRA8v3)
TESTLAYER_CREATE_FUNC(TexturePVRI8)
TESTLAYER_CREATE_FUNC(TexturePVRI8v3)
TESTLAYER_CREATE_FUNC(TexturePVRAI88)
TESTLAYER_CREATE_FUNC(TexturePVRAI88v3)
TESTLAYER_CREATE_FUNC(TexturePVRv3Premult)
TESTLAYER_CREATE_FUNC(TexturePVRBadEncoding)
